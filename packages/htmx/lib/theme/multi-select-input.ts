...
export function MultiSelectInput(properties: MultiSelectInputProperties) {
  ...
  return renderTemplate(templates.MultiSelectInput, {
    id: properties.id,
    path,
    ...
    ...attributes,
  } satisfies MultiSelectInputTemplateProperties);
}
