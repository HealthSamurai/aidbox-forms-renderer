import{j as r}from"./index-BsWNCus6.js";import{b as s,a as i,N as t,c as p,m as l}from"./helpers-BRoEs9rh.js";import"./iframe-DXtTJtIS.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BXc-CYbp.js";import"./form-DWk4cvsd.js";const n=p({linkId:"date-wc-autocomplete-non-repeating-options-only",text:"Select a date",type:"date",repeats:!1,control:"autocomplete",answerConstraint:"optionsOnly",answerOption:l("date",["2025-02-01","2025-03-01","2025-04-01"])}),o=JSON.stringify(n.form.questionnaire,null,2),f={title:"Question/date/with item-control/autocomplete/non-repeating/with answer-options",component:t,parameters:i,argTypes:s},e={name:"options only",args:{questionnaireSource:o},render:a=>r.jsx(t,{scenario:{name:"date-wc-autocomplete-non-repeating-options-only",title:"options only",build:()=>n},questionnaireSource:a.questionnaireSource,defaultSource:o})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  name: "options only",
  args: {
    questionnaireSource: defaultSource
  },
  render: args => <NodeShell scenario={{
    name: "date-wc-autocomplete-non-repeating-options-only",
    title: "options only",
    build: () => defaultNode
