...
} satisfies StoryObj<TableGroupArguments>`,...f.parameters?.docs?.source}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  name: "Grid",
  args: {
...
} satisfies StoryObj<GridGroupArguments>`,...h.parameters?.docs?.source}}};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  name: "Grid Table",
  ...makeStory(buildGroupItem({
    linkId: "group-gtable",
    text: "Medications",
