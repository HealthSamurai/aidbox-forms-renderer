...
import type { INonRepeatingGroupNode, INodeValidator } from "./types.ts";

export class NonRepeatingGroupValidator implements INodeValidator {
  private readonly group: INonRepeatingGroupNode;

  constructor(group: INonRepeatingGroupNode) {
    this.group = group;
